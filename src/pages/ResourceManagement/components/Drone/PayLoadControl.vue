...
<!--          <div >负载：M3TD</div>-->
          <div class="drone-control">
            <el-button class="btn" size="small" @click="onAuthPayload">{{ payloadController ? '推出无人机控制' : '获取无人机控制'}}</el-button>
          </div>
        </div>
        <div class="row">
          <DroneControlPopover
...
<!--                  <el-select-->
<!--                      v-model:value="gimbalResetPopoverData.visible"-->
<!--                      style="width: 180px"-->
...
<!--              </div>-->
<!--            </template>-->
<!--            <el-button class="btn" size="small" @click="onShowGimbalResetPopover">云台角度重置</el-button>-->
            <el-button class="btn" size="small" @click="GimbalRecenter">云台回中</el-button>
            <el-button class="btn" size="small" @click="GimbalDown">云台俯视</el-button>
          </DroneControlPopover>
        </div>
<!--        <div class="row">-->
<!--          <div class="from">-->
<!--            <el-button class="btn" size="small" @click="onShowGimbalResetPopover">云台重置</el-button>-->
<!--            <el-button class="btn" size="small" @click="onStopFlyToPoint">相机模式</el-button>-->
<!--            <el-button class="btn" size="small" @click="onStopFlyToPoint">开始录制</el-button>-->
<!--            <el-button class="btn" size="small" @click="onStopFlyToPoint">停止录制</el-button>-->
<!--          </div>-->
<!--        </div>-->
<!--        <div class="row">-->
<!--          <div class="from">-->
<!--            <el-button class="btn" size="small" @click="onShowFlyToPopover">拍照</el-button>-->
<!--            <el-button class="btn" size="small" @click="onStopFlyToPoint">放大</el-button>-->
<!--            <el-button class="btn" size="small" @click="onStopFlyToPoint">聚焦</el-button>-->
<!--          </div>-->
<!--        </div>-->
      </div>
    </div>
