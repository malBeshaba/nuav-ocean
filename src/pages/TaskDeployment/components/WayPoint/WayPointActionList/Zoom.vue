<template>
  <div class="record-component">
    ...
    <!--    //写在这里是暂时有Bug调不了参数-->
    <el-row :gutter="17">
      <el-col :span="3"><el-button  class="WaitTime15" size="medium" @click="setDroneYawNum(300)">300m</el-button></el-col>
      <el-col :span="3"><el-button  class="WaitTime15" size="medium" @click="setDroneYawNum(400)">400m</el-button></el-col>
      <el-col :span="9"><el-input-number class="HoverNumInputOne" size="medium" v-model="DroneYawNum"></el-input-number></el-col>
      <el-col :span="3"><el-button  size="medium" class="WaitTime15" @click="setDroneYawNum(600)">600m</el-button></el-col>
      <el-col :span="3"><el-button  size="medium" class="WaitTime20" @click="setDroneYawNum(700)">700m</el-button></el-col>
    </el-row>
  </div>
</template>
    ...
    DroneYawNum(newVal) {
      const CombinedData = {
        ...
        ActionParam:{
          ...
          //因为在前面定义出现传值未定义的问题，懒得改了直接写在下面
          payloadPositionIndex:1,
          useGlobalPayloadLensIndex:newVal
        }
      };
      this.$emit('HandleReturnValues',this.fatherMsg,CombinedData);
    },
