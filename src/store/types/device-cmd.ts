import { AlarmModeEnum, BatteryStoreModeEnum, DroneBatteryModeEnum, LinkWorkModeEnum } from '@/store/types/airport-tsa'
// 机场指令集
...
export type DeviceCmdItemAction = AlarmModeEnum | BatteryStoreModeEnum | DroneBatteryModeEnum | LinkWorkModeEnum | undefined
...
export const cmdList: DeviceCmdItem[] = [
  ...
  },
  {
    ...
    status: '关',
    operateText: '打开',
    funcS: DeviceCmd.SupplementLightOpen,
  ...
  },
  {
    ...
    status: '关',
    operateText: '打开',
    funcS: DeviceCmd.AlarmStateSwitch,
  ...
  },
  {
    ...
    status: '计划',
    operateText: '应急',
    funcS: DeviceCmd.BatteryStoreModeSwitch,
  ...
  },
  {
    ...
    status: '--',
    operateText: '保养',
    funcS: DeviceCmd.DroneBatteryModeSwitch,
  ...
  },
  {
    ...
    status: '--',
    operateText: '开启',
    funcS: DeviceCmd.SdrWorkModeSwitch,
